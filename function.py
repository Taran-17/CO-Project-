...
class function:
    ...
    @staticmethod
    def stliu(imm, rs, rd):
        rs_unsigned = binary_to_decimal_unsigned(rs)
        imm_unsigned = binary_to_decimal_unsigned(imm)
    ...
    @staticmethod
    def addi(imm, rs):
        r1_int = binary_to_decimal_signed(rs)
        imm_int = binary_to_decimal_signed(imm)
        rd = r1_int + imm_int
